...
export async function deleteComment1(code, postId, comment) {
  await updateDoc(doc(db, 'rooms', code, 'step1Posts', postId), { comments: arrayRemove(comment) })
}
...
export async function deleteComment4(code, postId, comment) {
  await updateDoc(doc(db, 'rooms', code, 'step4Posts', postId), { comments: arrayRemove(comment) })
}
